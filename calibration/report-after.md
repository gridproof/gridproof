# Gridproof calibration — AFTER (v1.2 rules + viewport-aware tap-target)
...
- Elements: **734**
- Total: **0** (0 error, 0 warn)
- By rule: spacing-scale=0, arbitrary-value=0, gap-consistency=0, canonical-size=0
